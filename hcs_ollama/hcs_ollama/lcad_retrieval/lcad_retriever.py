...
try:
    from hcs_ollama.lcad_retrieval.create_faiss_index import create_df_corpus_from_json, create_df_corpus_from_txt, pdf_to_text, create_index
    from hcs_ollama.lcad_retrieval.ollama_embedding import OllamaEmbedding
except Exception:
    from hcs_ollama.lcad_retrieval.create_faiss_index import create_df_corpus_from_json, create_df_corpus_from_txt, pdf_to_text, create_index
    from hcs_ollama.lcad_retrieval.ollama_embedding import OllamaEmbedding
